...
- Paper 1.21 - 26.2 or a compatible server build.
- Java 21\+.
...
The complete permission reference is available in [Permissions](permissions.md). Feature-specific documentation is available in the Modules tab.
