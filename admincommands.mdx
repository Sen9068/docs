...
12. **/chatspy** › Shows in chat every command that every player sends
13. **/glow (player)** › Shows the glow menu gui for setting glow color
...
| `smp.opcommands.chatspy` | Allows /chatspy | op |